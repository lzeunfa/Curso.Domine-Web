...
class Bd{
    ...
    recuperarTodosRegistros(){
        ...
        for(let i =1;i<=id;i++){
            ...
            //existe a possibilidade de haver indices que foram pulados
            //neste caso nos vamos pular os indices
            if(despesa===null){
                continue;
            }
...
function cadastrarDespesa(){
    ...
    if(despesa.validarDados()){
        ...
        document.getElementById("modal_btn").innerHTML = "Voltar e corrigir erro";
...
function carregaListaDespesa(despesas = [], filtro = false){
    ...
    //selecioanndo elemento tbody
    let listaDespesas = document.getElementById("listaDespesas");
    listaDespesas.innerHTML = '';

    //percorrer o array despesas, listando cada despesa de forma dinâmicas
